...
Personally I think the original statement 3.21 is pretty confusing.  I could 
...
\begin{proof}{Using results from topology.}
  ...
  $U_i$ a finite cover of $C$ by closed rectangles. Then $U = U_i$ is a finite union 
  of closed sets, hence closed. The closure of a set is by definition the smallest 
  closed set and yet also contains that set's boundary, whence
...
\begin{theorem}
  ...
  Then the set of all $k$-fold tensor products of $\varphi_i$ 
